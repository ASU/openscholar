...
class VsiteBackupRestfulLayoutsOverrides extends \VsiteBackupRestfulLayouts {
  ...
  public function getLayout() {
    ...
    if($this->request['vsite']['sid'] && is_numeric($this->request['vsite']['sid'])){
      ...
      watchdog('vsite_export', t('Vsite Backup RESTful endpoint receiving non-integer Vsite ID'));
      return array();
    }
