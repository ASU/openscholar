...
/**
 * @file
 * Contains \VsiteBackupRestfulSpaces
 */

class VsiteBackupRestfulSpacesOverrides extends \VsiteBackupRestfulSpaces {
  ...
  public function getSpace() {
    ...
    if($this->object->vsite && is_numeric($this->object->vsite)){
      ...
      watchdog('vsite_export', 'Vsite Backup RESTful endpoint receiving non-integer vsite ID');
      return array();
    }
