...
/**
 * @file
 * Contains \VsiteBackupRestfulLayouts
 */
abstract class VsiteBackupRestfulLayouts extends \VsiteBackupRestfulDataProvider {
  ...
  public static function controllersInfo() {
    return array(
      '' => array(
        ...
        \RestfulInterface::POST => 'createLayout',
        \RestfulInterface::PUT => 'updateLayout',
        \RestFulInterface::DELETE => 'deleteLayout',
      ),
      '^.*$' => array(
        \RestfulInterface::GET => 'getLayout',
      ),
  ...
  abstract public function updateLayout();
  abstract public function deleteLayout();
  ...
  public function getLayout() {
    ...
    if (!empty($request['type']) && !empty($list[0]['value'][$request['type']])) {
      // We need a sub value from the layout.
